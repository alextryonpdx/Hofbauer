...
<?php if($_video_type == "youtube") { ?>
	<iframe  src="https://www.youtube.com/embed/<?php echo esc_attr(get_post_meta(get_the_ID(), "edgtf_post_video_id_meta", true));  ?>?wmode=transparent&amp;showinfo=0" wmode="Opaque" width="500" height="281" allowfullscreen></iframe>
