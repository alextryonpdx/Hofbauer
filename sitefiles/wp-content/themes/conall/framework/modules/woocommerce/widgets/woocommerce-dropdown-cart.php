							...
							<?php foreach ( $woocommerce->cart->get_cart() as $cart_item_key => $cart_item ) :
								...
								<li>
									...
									<div class="edgtf-item-info-holder">
										<a href="<?php echo esc_url(get_permalink( $cart_item['product_id'] )); ?>"><?php echo apply_filters('woocommerce_widget_cart_product_title', $_product->get_name(), $_product ); ?></a>
...
add_filter('woocommerce_add_to_cart_fragments', 'conall_edge_woocommerce_header_add_to_cart_fragment');
