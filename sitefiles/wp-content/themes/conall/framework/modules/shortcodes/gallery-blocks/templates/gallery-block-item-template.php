	...
	<div class="edgtf-gb-item-inner" <?php echo conall_edge_get_inline_style($holder_styles); ?>>
		...
		<?php if($block_item_type === 'edgtf-text-block') { ?>
			...
			<?php if($button_link !== '' && $button_link_text !== '') { ?>
				<a href="<?php echo esc_url($button_link); ?>" target="<?php echo esc_attr__($button_link_target); ?>" <?php conall_edge_inline_style($button_styles); ?> <?php conall_edge_class_attribute($button_classes); ?> <?php echo conall_edge_get_inline_attrs($button_data); ?>>
